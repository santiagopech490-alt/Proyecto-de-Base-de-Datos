...
<task>
Genera un archivo de clase (Client.cs) que representen el núcleo de negocio, aplicando principios SOLID y las optimizaciones sintácticas de C# 14.
</task>

<domain_model_requirements>
1. Entidad "Client":
   - Propiedades: Customer.ID (PK), FullName, Email, IsActive. 
...
1. Código fuente completo y documentado para la clase.
