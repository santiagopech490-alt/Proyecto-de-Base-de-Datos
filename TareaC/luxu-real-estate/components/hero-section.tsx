        ...
        <div className="max-w-3xl mx-auto text-center space-y-8">
          ...
          <div className="relative group max-w-2xl mx-auto">
            ...
            <Input
              ...
              type="text"
            />
            <Button className="absolute inset-y-2 right-2 px-6 h-auto bg-[#006655] hover:bg-[#006655]/90 text-white font-medium rounded-lg transition-colors shadow-lg shadow-[#006655]/20">
              Search
            </Button>
          </div>
          ...
          <div className="flex items-center justify-center gap-3 overflow-x-auto pb-2 px-4 -mx-4 no-scrollbar">
            ...
            <Button
              variant="ghost"
              className="flex items-center gap-2 px-4 py-2 h-auto rounded-full text-[#19322F] font-medium text-sm hover:bg-black/5 transition-colors"
            >
