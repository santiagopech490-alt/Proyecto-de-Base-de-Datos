...
export function FiltersModal() {
  ...
  const TriggerButton = (
    <div className="inline-flex h-8 items-center justify-center rounded-lg border border-emerald-100 bg-background px-2.5 text-sm font-medium transition-all hover:bg-emerald-50 text-emerald-800 gap-2 cursor-pointer">
