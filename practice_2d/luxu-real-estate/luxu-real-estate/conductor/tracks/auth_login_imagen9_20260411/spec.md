...
- **UI Frameworks:** Next.js 16 (App Router), Tailwind CSS 4, shadcn/ui (Card, Button).
- **Aesthetics:**
    - **Background:** Subtle radial gradient from Mint (#F0F9F6) to Off-white (#F7FCFA).
    - **Card:** Floating white card (shadcn/ui Card) with soft shadows and rounded corners (16px).
    - **Buttons:** Custom styled shadcn/ui Buttons with thin borders (1px #E6E8EC) and rounded corners (8px).
