      ...
      <Table>
        <TableHeader>
          <TableRow className="bg-slate-50/50 hover:bg-slate-50/50 border-b border-slate-100">
            <TableHead className="font-bold text-[11px] tracking-wider text-slate-500 py-4">USER DETAILS</TableHead>
            <TableHead className="font-bold text-[11px] tracking-wider text-slate-500">ROLE & STATUS</TableHead>
            <TableHead className="font-bold text-[11px] tracking-wider text-slate-500">PERFORMANCE</TableHead>
            <TableHead className="font-bold text-[11px] tracking-wider text-slate-500 text-right">ACTIONS</TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
          {users.map((user) => (
            <TableRow key={user.id} className="border-b border-slate-50 hover:bg-slate-50/80 transition-colors">
              ...
              <TableCell>
                <div className="flex gap-8">
                  <div>
                    <p className="text-[10px] text-slate-400 uppercase tracking-wider mb-0.5">Properties</p>
                    <p className="font-semibold text-[#19322F]">{user.properties_count || 0}</p>
                  </div>
                  <div>
                    <p className="text-[10px] text-slate-400 uppercase tracking-wider mb-0.5">Sales (YTD)</p>
