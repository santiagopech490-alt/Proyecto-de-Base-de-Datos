        ...
        <div className="max-w-3xl mx-auto text-center space-y-8">
          ...
          <div className="relative group max-w-2xl mx-auto">
            ...
            <Button 
              ...
              className="absolute inset-y-2 right-2 px-6 h-auto bg-[#006655] hover:bg-[#006655]/90 text-white font-medium rounded-lg transition-colors shadow-lg shadow-[#006655]/20 cursor-pointer"
            >
              {t("hero.searchBtn")}
            </Button>
          </div>
