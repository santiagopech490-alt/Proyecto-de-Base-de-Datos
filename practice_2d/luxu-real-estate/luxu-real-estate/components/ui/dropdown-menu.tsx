...
function DropdownMenuTrigger({ asChild, render, children, ...props }: any) {
  ...
  if (targetRender) {
    ...
    return <MenuPrimitive.Trigger data-slot="dropdown-menu-trigger" nativeButton={isBtn} render={targetRender} {...props} />;
  }
  ...
  if (render) {
    return (
      <MenuPrimitive.Item
        ...
        render={render}
        className={cn(
          "group/dropdown-menu-item relative flex cursor-pointer items-center gap-1.5 rounded-md px-2 py-1.5 text-sm outline-hidden select-none focus:bg-accent focus:text-accent-foreground data-inset:pl-7 data-[variant=destructive]:text-destructive data-[variant=destructive]:focus:bg-destructive/10 data-disabled:pointer-events-none data-disabled:opacity-50",
          className
        )}
        {...props}
      />
