...
const translations = {
  es: {
    ...
    filtersModal: {
      ...
      locationPlaceholder: "Ciudad, código postal o colonia",
      ...
      bathrooms: "Baños",
      any: "Cualquiera",
      amenitiesTitle: "AMENIDADES Y SERVICIOS",
      swimmingPool: "Alberca / Piscina",
      gym: "Gimnasio",
  ...
  en: {
    ...
    filtersModal: {
      ...
      locationPlaceholder: "City, Zip or Neighborhood",
