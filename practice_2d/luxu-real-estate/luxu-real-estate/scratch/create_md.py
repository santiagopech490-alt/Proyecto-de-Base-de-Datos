...
def create_markdown_doc():
    md_path = r"c:\home\practice_2d\luxu-real-estate\luxu-real-estate\documentacion_luxu_real_estate.md"
    content = """# DOCUMENTACIÓN OFICIAL DEL PROYECTO DE BASE DE DATOS
