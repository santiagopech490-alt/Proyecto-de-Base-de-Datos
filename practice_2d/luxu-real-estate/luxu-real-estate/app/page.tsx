...
// Wrapper component to provide searchParams as a key for re-rendering
        ...
        {itemsToShow < filteredMarketProperties.length && (
          <div className="mt-12 text-center">
            <Button 
              ...
              variant="outline" 
              className="px-8 py-6 bg-white border-gray-100 hover:border-[#006655] hover:text-[#006655] text-[#19322F] font-medium rounded-lg transition-all hover:shadow-md"
            >
