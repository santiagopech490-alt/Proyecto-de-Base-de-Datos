<expert_system_instruction>
    ...
    <connection_data>
        <raw_string>workstation id=developer-utm-SAPA.mssql.somee.com;packet size=4096;user id=SantiagoAsahelTheChampion;pwd=Past12,.;data source=developer-utm-SAPA.mssql.somee.com;persist security info=False;initial catalog=developer-utm-SAPA;TrustServerCertificate=True</raw_string>
    </connection_data>
