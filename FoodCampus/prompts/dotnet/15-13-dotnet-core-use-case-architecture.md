...
<task_description>
  ...
  1. El método debe recibir un valor entero llamado `threshold` (umbral).
  2. Debe devolver un `IAsyncEnumerable<Product>` que contenga solo aquellos productos cuyo stock sea menor o igual al umbral especificado.
  3. El nuevo servicio debe quedar registrado correctamente en el contenedor de servicios del archivo `Program.cs`.
  4. El flujo de datos debe ser asíncrono y eficiente en memoria.
</task_description>
...
<technical_constraints>
  ...
  <rule_set name="Nomenclatura y Ubicación">
    ...
    - Convención de nombre: ILowStockAlertUseCase.cs
...
<quality_gate>
  ...
  - ¿El nombre sigue el estándar ILowStockAlertUseCase?
</quality_gate>