<system_instruction>
  ...
  <technical_landscape>
    El proyecto, [TareaDeProgramacion.csproj], es una aplicación de consola en .NET 10 optimizada para el despliegue Native AOT. 
    Restricciones clave:
...
<context>
  <project_metadata>
    Nombre del Proyecto: [TareaDeProgramacion.csproj]
